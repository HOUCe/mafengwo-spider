...
angular.module('articles').controller('ArticlesController', ['$sce', '$scope', '$routeParams', '$location', 'Authentication', 'Articles',
    function($sce, $scope, $routeParams, $location, Authentication, Articles) {
        ...
        $scope.findOne = function() {
            ...
            var article = Articles.get({
                ...
                article.content = $sce.trustAsHtml(remote.content);
            });
